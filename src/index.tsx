...
function Index() {
  return (
    <>
      <div class="container relative lg:h-screen flex-col items-center justify-center lg:grid lg:max-w-none lg:grid-cols-2 lg:px-0">
        <div class="relative flex h-full flex-col bg-muted p-6 text-white lg:flex">
          ...
          <footer class="z-20 mt-2">
            ...
            <button onClick={() => window.location.assign("not-found")}>hello</button>
          </footer>
        </div>
